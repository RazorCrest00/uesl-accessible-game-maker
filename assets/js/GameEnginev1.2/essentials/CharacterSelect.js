                ...
                characters: [
                    {
                        ...
                        src: `${p}/images/gamify/pokemon/pikachu_cs.svg`,
                        greeting: 'Pika pika! I am Pikachu, the Electric Mouse Pokémon!',
                        SCALE_FACTOR: 4, STEP_FACTOR: 1000, ANIMATION_RATE: 100,
                    ...
                    },
                    {
                        ...
                        src: `${p}/images/gamify/pokemon/charmander_cs.svg`,
                        greeting: 'Char char! I am Charmander, the Lizard Pokémon. My tail flame shows my health!',
                        SCALE_FACTOR: 4, STEP_FACTOR: 1000, ANIMATION_RATE: 100,
                        pixels: { height: 200, width: 200 },
                        orientation: { rows: 1, columns: 1 },
                        down: { row: 0, start: 0, columns: 1 }, left: { row: 0, start: 0, columns: 1 },
                    ...
                    },
                    {
                        ...
                        src: `${p}/images/gamify/pokemon/bulbasaur_cs.svg`,
                        greeting: 'Bulba bulba! I am Bulbasaur. The seed on my back grows stronger every day!',
                        SCALE_FACTOR: 4, STEP_FACTOR: 1000, ANIMATION_RATE: 100,
                        pixels: { height: 200, width: 200 },
                        orientation: { rows: 1, columns: 1 },
                        down: { row: 0, start: 0, columns: 1 }, left: { row: 0, start: 0, columns: 1 },
                    ...
                    },
                    {
                        ...
                        src: `${p}/images/gamify/pokemon/squirtle_cs.svg`,
                        greeting: 'Squirtle squirtle! I am Squirtle. My shell is tougher than it looks!',
                        SCALE_FACTOR: 4, STEP_FACTOR: 1000, ANIMATION_RATE: 100,
                        pixels: { height: 200, width: 200 },
                        orientation: { rows: 1, columns: 1 },
                        down: { row: 0, start: 0, columns: 1 }, left: { row: 0, start: 0, columns: 1 },
                    ...
                    },
                    {
                        ...
                        src: `${p}/images/gamify/pokemon/jigglypuff_cs.svg`,
                        greeting: 'Jigglypuff! I am Jigglypuff. My song is so beautiful it puts everyone to sleep!',
                        SCALE_FACTOR: 4, STEP_FACTOR: 1000, ANIMATION_RATE: 100,
                        pixels: { height: 200, width: 200 },
                        orientation: { rows: 1, columns: 1 },
                        down: { row: 0, start: 0, columns: 1 }, left: { row: 0, start: 0, columns: 1 },
